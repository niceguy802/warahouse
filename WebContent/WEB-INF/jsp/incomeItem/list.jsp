...
<html>
  <head>
    ...
    $(function(){
        ...
        var queryURL = "${pageContext.request.contextPath}/incomeItems/list"; 
     $table=$('#incomeItem_table').bootstrapTable({
            ...
            queryParams : function (params) {
            	...
            	delete params.limit;
            	var incomeId = $("#searchForm input[name='incomeId']").val();
            	if(incomeId){
        ...
        <section class="content">
          <div class="row">
            ...
            <form id="searchForm" action="" onsubmit="return false;">
              <div class="col-xs-2">
                <input type="text" name="incomeId" class="form-control" placeholder="订单编号">
              </div>
              <div class="col-xs-2">
          ...
          <table id="incomeItem_table"></table>
        </section>
