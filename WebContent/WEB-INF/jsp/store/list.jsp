    ...
    $(function(){
    	...
    	$("#toolbar button").on("click",function(){
    		...
    		if(ope=="delete"){
    			...
    			$.ajax({
    				type:"post",
    				url:"${pageContext.request.contextPath}/stores/delete",
    				data:"id="+ids.join("&id="),
    			...
    			//编辑
    			window.location.href="/WMS/stores/edit?id="+rowValue[0].id;
    		}
    	});
        ...
        var queryURL = "${pageContext.request.contextPath}/stores/list"; 
     $table=$('#store_table').bootstrapTable({
            ...
            queryParams : function (params) {
            	...
            	delete params.limit;
            	var storeName = $("#searchForm input[name='name']").val();
            	if(storeName){
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div id="toolbar">
            <div id="toolbar">
              <a href="${pageContext.request.contextPath}/stores/add" type="button" class="btn bg-maroon btn-flat">添加</a>
