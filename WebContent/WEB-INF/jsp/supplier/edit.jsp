        	...
        	$('#supplier-form').bootstrapValidator({
        	      ...
        	      fields: {
        	        ...
        	        phone: {
          	          ...
          	          stringLength: {//校验字段的长度，最小2位最大30位
        	              min: 2,
        	              max: 11,
        	              message: '电话号码最大只能为11位'
        	            }
          	          }
          	        },      	
          	      address: {
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
           ...
           <div class="box box-info">
            ...
            <form:form  id="supplier-form" cssClass="form-horizontal" action="${pageContext.request.contextPath}/suppliers/edit" method="post" modelAttribute="supplier">
