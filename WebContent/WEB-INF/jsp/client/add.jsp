      ...
      <div class="content-wrapper">
        ...
        <section class="content">
           ...
           <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form   id="client-form" class="form-horizontal" action="${pageContext.request.contextPath}/clients/add" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="sn" id="address" placeholder="客户编号">
                  </div>
                </div>
                </div>
                </div>
