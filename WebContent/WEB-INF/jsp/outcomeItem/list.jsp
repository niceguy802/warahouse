...
<html>
  <head>
    ...
    $(function(){
        ...
        var queryURL = "${pageContext.request.contextPath}/outcomeItems/list"; 
         $table=$('#outcomeItem_table').bootstrapTable({
            ...
            queryParams : function (params) {
            	...
            	delete params.limit;
            	var outSn = $("#searchForm input[name='outSn']").val();
            	if(outSn){
            		params.outSn=outSn;
            	}
                return params;
        ...
        <section class="content">
          <div class="row">
            ...
            <form id="searchForm" action="" onsubmit="return false;">
              <div class="col-xs-2">
                <input type="text" name="outSn" class="form-control" placeholder="订单编号">
              </div>
              <div class="col-xs-2">
          ...
          <table id="outcomeItem_table"></table>
        </section>
