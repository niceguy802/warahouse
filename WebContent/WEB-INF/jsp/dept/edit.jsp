      ...
      <div class="content-wrapper">
        ...
        <section class="content">
           ...
           <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form id="dept" class="form-horizontal" action="${pageContext.request.contextPath}/depts/edit" method="post" modelAttribute="dept"> 
              ...
              <div class="box-body">   
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" id="name" placeholder="名字" value="${dept.name}">
                  </div>
