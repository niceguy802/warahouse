        ...
        <section class="content">
           ...
           <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">编辑品牌信息</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            
            <form:form   id="brand-form" cssClass="form-horizontal" action="${pageContext.request.contextPath}/brands/edit" method="post" modelAttribute="brand">
