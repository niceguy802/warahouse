    ...
    $(function(){
    	...
    	$("#toolbar button").on("click",function(){
    		...
    		if(ope=="delete"){
    			...
    			$.ajax({
    				type:"post",
    				url:"${pageContext.request.contextPath}/brands/delete",
    				data:"id="+ids.join("&id="),
    			...
    			//编辑
    			window.location.href="/WMS/brands/edit?id="+rowValue[0].id;
    		}
    	});
        ...
        var queryURL = "${pageContext.request.contextPath}/brands/list"; 
     $table=$('#brand_table').bootstrapTable({
            ...
            pageSize:8,               //每页显示的数量
            pageList: [8, 10, 20, 50, 100],       //设置每页显示的数量

            queryParams : function (params) {
            	//携带查询条件中的角色名
            	params.pageSize=params.limit;
            	delete params.limit;
            	var brandName = $("#searchForm input[name='name']").val();
            	if(brandName){
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div id="toolbar">
            <div id="toolbar">
              <a href="${pageContext.request.contextPath}/brands/add" type="button" class="btn bg-maroon btn-flat">添加</a>
              <button type="button" data-ope="delete" class="btn bg-olive btn-flat" onclick="fun()" >删除</button>
